...
namespace Connect4
{
    class Juego
    {
        ...
        public enum state { vacio = 0, jugador1 = 1, jugador2 = 2 };
        ...
        public Juego(int x, int y, Color pcolor)
        {       
        ...
        public void dibujarPieza(MouseEventArgs e, Graphics f)
        {
            ...
            if (lleno[xlocal] >= 0)
            {
                ...
                else if (jugador2 && tablero[xlocal, lleno[xlocal]] == state.vacio)
                {
                    tablero[xlocal, lleno[xlocal]] = state.jugador2;
                    f.FillEllipse(pincel, xlocal * 100, lleno[xlocal] * 100, 100, 100);
                    lleno[xlocal]--;
                    turnoJugador();
                }
